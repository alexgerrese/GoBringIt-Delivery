...
internal protocol Requestable {
    func response(_ queue: DispatchQueue?, completionHandler: @escaping RequestableCompletion) -> Self
}

extension DataRequest: Requestable {
    internal func response(_ queue: DispatchQueue?, completionHandler: @escaping RequestableCompletion) -> Self {
