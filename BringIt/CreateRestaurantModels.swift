...
//                            self.realm.add(promotion)
            ...
            case let .success(moyaResponse):
                do {
                    ...
                    DispatchQueue.global(qos: .background).async {
                         self.createRestaurants(retrievedRestaurants: retrievedRestaurants)
                    }
                } catch {
                    // Miscellaneous network error
    ...
    func createRestaurants(retrievedRestaurants: [AnyObject]) {
        
        let realm = try! Realm() // Initialize Realm
        
        print("createRestaurants() was called.")
        ...
        print("Finished creating Restaurant models.")
